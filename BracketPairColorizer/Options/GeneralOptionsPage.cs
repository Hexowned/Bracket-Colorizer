...
namespace BracketPairColorizer.Options
{
    ...
    public class GeneralOptionsPage : DialogPage
    {
        ...
        public override void SaveSettingsToStorage()
        {
            ...
            settings.ModelinesNumberLines = (int)ModelinesNumberLines;
        ...
        public override void LoadSettingsFromStorage()
        {
            ...
            ModelinesNumberLines = (uint)settings.ModelinesNumberLines;
            TelemetryEnabled = settings.TelemetryEnabled;

            this.colors = new ClassificationList(new ColorStorage(this.Site));
            this.colors.Load(Constants.LINE_HIGHLIGHT,
                             Constants.COLUMN_HIGHLIGHT,
                             Constants.FLOW_CONTROL_CLASSIFICATION_NAME,
                             Constants.LINQ_CLASSIFICATION_NAME,
                             Constants.VISIBILITY_CLASSIFICATION_NAME,
                             Constants.STRING_ESCAPE_CLASSIFICATION_NAME,
        ...
        [Category("General")]
        public Core.Outlining.AutoExpandMode AutoExpandRegions { get; set; }
        ...
        {
            get { return this.colors.Get(Constants.FLOW_CONTROL_CLASSIFICATION_NAME, true); }
            set { this.colors.Set(Constants.FLOW_CONTROL_CLASSIFICATION_NAME, true, value); }
        }
        ...
        {
            get { return this.colors.Get(Constants.LINQ_CLASSIFICATION_NAME, true); }
            set { this.colors.Set(Constants.LINQ_CLASSIFICATION_NAME, true, value); }
        }
        ...
        {
            get { return this.colors.Get(Constants.VISIBILITY_CLASSIFICATION_NAME, true); }
            set { this.colors.Set(Constants.VISIBILITY_CLASSIFICATION_NAME, true, value); }
        }
        ...
        {
            get { return this.colors.Get(Constants.STRING_ESCAPE_CLASSIFICATION_NAME, true); }
            set { this.colors.Set(Constants.STRING_ESCAPE_CLASSIFICATION_NAME, true, value); }
        }
        ...
        [Category("Modelines")]
        public uint ModelinesNumberLines { get; set; }
    }
}
