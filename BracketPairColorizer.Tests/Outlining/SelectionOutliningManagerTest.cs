...
namespace BracketPairColorizer.Tests.Outlining
{
    public class SelectionOutliningManagerTest : VsTestBase
    {
        [Fact]
        public void GetTagsReturnsRegionsAdded()
        {
            ...
            var allDocs = new NormalizedSnapshotSpanCollection(snapshot.GetSpan());
            var tags = manager.GetTags(allDocs).ToList();
