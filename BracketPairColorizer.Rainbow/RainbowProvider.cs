...
{
    public class RainbowProvider : IWeakEventListener
    {
        ...
        internal RainbowProvider(ITextBuffer buffer, RainbowTaggerProvider provider)
        {
        ...
        public static bool TryMapPosToBuffer(ITextView view, SnapshotPoint viewPos, out SnapshotPoint pos)
        {
            ...
            var result = view.BufferGraph.MapDownToFirstMatch(viewPos, PointTrackingMode.Negative, snapshot
                => snapshot.TextBuffer.Has<RainbowProvider>(), PositionAffinity.Successor);
        ...
        public static bool TryMapToView(ITextView view, SnapshotPoint pos, out SnapshotPoint result)
        {
            ...
            var temp = view.BufferGraph.MapUpToBuffer(pos, PointTrackingMode.Negative, PositionAffinity.Successor, target);
        ...
        private void UpdateBraceList(SnapshotPoint startPoint, bool notifyUpdate)
        {
            ...
            int lastPosition = this.BufferBraces.LastParsedPositon;
            if (lastPosition > 0 && lastPosition < startPoint.Snapshot.Length)
                restartPoint = new SnapshotPoint(startPoint.Snapshot, this.BufferBraces.LastParsedPositon);
        ...
        public bool RecieveWeakEvent(Type managerType, object sender, EventArgs e)
        {
