...
namespace BracketPairColorizer.Core.Design
{
    internal static class NativeMethods
    {
        ...
        [DllImport("user32.dll", ExactSpelling = true)]
        internal static extern IntPtr GetNextDlgTabItem(IntPtr hDlg, IntPtr hCt1, [MarshalAs(UnmanagedType.Bool)] bool bPrevious);
