...
namespace BracketPairColorizer.Core.Text
{
    ...
    [Name("BracketPairColorizer.bold-as-italics")]
    [ContentType(ContentTypes.Text)]
    [TextViewRole(PredefinedTextViewRoles.Document)]
    public class BoldAsItalics : IWpfTextViewCreationListener
    {
        [Import]
    ...
    public class BoldAsItalicsFormatter
    {
        ...
        private void MakeBoldItalics()
        {
            ...
            if (!enabled || this.working || this.formatMap.IsInBatchUpdate) { return; }
        ...
        private void MakeItalicsIfApplies(IClassificationType classifierType)
        {
            ...
            if (tp.Italic || font.Style == FontStyles.Italic) { return; }
            ...
            {
                var newFont = new Typeface(font.FontFamily, FontStyles.Italic, FontWeights.Normal, FontStretches.Normal);
