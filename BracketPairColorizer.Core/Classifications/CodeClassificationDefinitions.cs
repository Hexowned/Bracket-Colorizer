...
namespace BracketPairColorizer.Core.Classifications
{
    public static class CodeClassificationDefinitions
    {
        ...
        [Export, Name(Constants.VISIBILITY_CLASSIFICATION_NAME)]
